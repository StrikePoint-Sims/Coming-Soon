  ...
  return {
    ...
    htmlContent: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px;background:#0a0a0a;color:#fff">
        <img src="${APP_URL}/logo.png" alt="StrikePoint Sims" height="52" style="margin-bottom:28px">
        <h2 style="color:#A97845;margin:0 0 8px;font-size:20px">You're booked, ${firstName}.</h2>
        ...
        <a href="${APP_URL}/book/${bookingId}" style="display:inline-block;padding:12px 24px;background:#1B4332;color:#A97845;border:1px solid #A97845;border-radius:8px;font-weight:700;text-decoration:none;font-size:14px">View booking →</a>
