...
export default function CheckEmailPage() {
  return (
    <div className="text-center">
      <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[rgba(212,175,55,0.06)] border border-[rgba(212,175,55,0.25)]">
        <svg viewBox="0 0 32 32" fill="none" stroke="#D4AF37" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8">
      ...
      <p className="text-xs text-[rgba(255,255,255,0.35)]">
        Didn&apos;t get it?{' '}
        <Link href="/login" className="text-[#D4AF37] hover:text-[#e6c651] transition-colors">
          Try again
        </Link>{' '}
